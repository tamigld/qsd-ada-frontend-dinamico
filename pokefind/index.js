...
buttonSearch.addEventListener('click', () => {
    ...
    if (pokemon.length !== 0) {
            ...
            .then(data => {
                ...
                fetch(`${baseUrl}/pokemon-species/${data.id}`)
                    ...
                    .then(data => {
                        ...
                        // loadTranslation(about, aboutText) expira rápido, limitada por ser grátis
                    })
                ...
                fetch(`${baseUrl}/characteristic/${data.id}`)
                    ...
                    .then(data => {
                        ...
                        // loadTranslation(charac, data.descriptions[7].description) expira rápido, limitada por ser grátis
                    })
                    .catch(error => {
        ...
        showModalInfo(modalInfo, '<p> Digite o nome de algum Pokémon.');
    }
});
